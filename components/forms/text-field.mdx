...
<Tabs>
  <Tab title="Left Adornment">
    ...
    <TextField
      ...
      adornments={{
        start: (
          <>
            <Icon name="call-end" color="currentColor" />
            +91
          </>
        )
      }}
  ...
  <Tab title="Both Sides">
    ...
    <TextField
      ...
      label="Custom Field"
      adornments={{
        start: <Icon name="call-end" color="currentColor" />,
...
```jsx
<TextField name="small" size="small" placeholder="Small (32px)" />
<TextField name="medium" size="medium" placeholder="Medium (40px)" />
<TextField name="large" size="large" placeholder="Large (48px)" />
<TextField name="xlarge" size="extra-large" placeholder="Extra Large (56px)" />
```
...
```jsx
// Text input
<TextField name="text" type="text" placeholder="Text input" />

// Number input
<TextField name="number" type="number" placeholder="Enter a number" min={0} max={100} step={1} />
