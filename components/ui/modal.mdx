...
```tsx
import Modal from '@grauity/ui/elements/Modal';
...
```tsx
// Fade (default)
<Modal animatePresence="fade" />

// Slide from bottom
<Modal animatePresence="slide" />

// Slide from top
<Modal animatePresence="slide-reverse" />
...
```tsx
import { ConfirmationDialog } from '@grauity/ui/elements/Modal';
...
```tsx
import { MultiStepModal } from '@grauity/ui/elements/Modal';
