...
```tsx
import { WeeklyCalendar } from '@grauity/ui';
import type { WeeklyCalendarProps, CalendarEvent } from '@grauity/ui';
```
...
```tsx
import { WeeklyCalendar, CalendarEvent } from '@grauity/ui';
import CalendarEvent from '@grauity/ui/CalendarEvent';
